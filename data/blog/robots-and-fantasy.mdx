...
- Wait, I think I've already seen this one 🤣, the episode where they are repairing the broken Red Mech is bringing the memories back. I don't think I completed it the first run tho.
- Got through episode 13, wish they focused more on the engineering part of things. Show is good enough to pass some time. The light novel may have approached it differently, can't promise a check that tho.
- ROFL, title is - Knights & Magic
